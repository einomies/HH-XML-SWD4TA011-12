...
//		String scheme = input01.nextLine();
		...
		Entry.Category cat = new Entry.Category();
...
//		BigDecimal price = BigDecimal.valueOf(0);
		String valuutta = "EUR";
		Entry.Price hintaYlataso = new Entry.Price();
		Entry.Price.StartingPrice aloitushinta = new Entry.Price.StartingPrice();
		...
		Entry.DeliveryMethods toimitustavat = new Entry.DeliveryMethods();
		String valinta = null;
		int dLkm = 0;
		do {
...
//			valinta = input01.next();
			...
			if (!valinta.equalsIgnoreCase("-")) {
				dLkm++;
				if (dLkm < 6) {
					Entry.DeliveryMethods.DeliveryMethod toimitustapa = new Entry.DeliveryMethods.DeliveryMethod();
	...
	public static void main(final String[] args) {
		...
		BigDecimalTest ohjelma = new BigDecimalTest();
